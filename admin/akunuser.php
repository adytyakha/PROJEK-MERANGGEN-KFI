...
<body>
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM akun_kfi  ");
 ...
 <td>
                                                 <span><a class="btn btn-warning btn-sm" href="editakun.php?id='.$array['id'].'"><i class="fa fa-edit (alias)"></i></a></span>

                                                

                                                  <span><a class="btn btn-danger btn-sm" onclick="return confirm(`Apakah Anda ingin Menghapus Id = '.$array['id'].' ?`)"href="controll/hapususer.php?id='.$array['id'].'" ><i  class="fa  fa-trash-o"></i></a></span>
