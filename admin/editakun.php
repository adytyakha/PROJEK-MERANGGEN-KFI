...
<body>
 ...
 <div class="content">
    ...
    $id = $_GET['id'];
    $query = mysqli_query($koneksi,"SELECT * FROM akun_kfi WHERE id='$id'");
    while($data = mysqli_fetch_array($query)){
        ?>             

 
                                <form action="controll/confeditakun.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label class=" form-control-label">ID</label></div>
                                       <div class="col-12 col-md-9"><input type="text" id="id" name="id" value="<?php echo $data['id']; ?>" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="row form-group">
