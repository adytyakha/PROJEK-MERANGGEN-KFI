...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Akun Admin</strong>
                            </div>
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM admin_kfi  ");
                        while($array = mysqli_fetch_array($query)){
                          echo '
                                        ...
                                        <tr>
                                            ...
                                            <td> <span class="name">'.$array['id_admin'].'</span> </td>
                                            <td>  <span class="name">'.$array['namalkp'].'</span> </td>
                                            <td> <span class="name">'.$array['email'].'</span> </td>
                                            

 <td>
                                                 <span><a class="btn btn-warning btn-sm" href="editakunadmin.php?id_admin='.$array['id_admin'].'"><i class="fa fa-edit (alias)"></i></a></span>

                                                

                                                  <span><a class="btn btn-danger btn-sm" onclick="return confirm(`Apakah Anda ingin Menghapus Id = '.$array['id_admin'].' ?`)"href="controll/hapusadmin.php?id_admin='.$array['id_admin'].'" ><i  class="fa  fa-trash-o"></i></a></span>
