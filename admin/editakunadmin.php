...
<body>
 ...
 <div class="content">
    ...
    $id = $_GET['id_admin'];
    $query = mysqli_query($koneksi,"SELECT * FROM admin_kfi WHERE id_admin='$id'");
    while($data = mysqli_fetch_array($query)){
        ?>             

 
                                <form action="controll/confeditadmin.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label class=" form-control-label">ID</label></div>
                                       <div class="col-12 col-md-9"><input type="text" id="id_admin" name="id_admin" value="<?php echo $data['id_admin']; ?>" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Lengkap</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="namalkp" name="namalkp" value="<?php echo $data['namalkp']; ?>"  class="form-control" required></div>
                                    </div>
                                         <div class="row form-group">
